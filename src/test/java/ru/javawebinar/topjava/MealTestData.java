...
public class MealTestData {
    ...
    public static final Meal MEAL1 = new Meal(MEAL1_ID, of(2015, Month.MAY, 30, 0, 0), "Завтрак", 500);
    ...
    public static final Meal MEAL4 = new Meal(MEAL1_ID + 3, of(2015, Month.MAY, 31, 0, 0), "Завтрак", 500);
    ...
    public static void assertMatch(Meal actual, Meal expected) {
        assertThat(actual).isEqualToComparingOnlyGivenFields(expected, "id", "description", "dateTime", "calories");
    }
