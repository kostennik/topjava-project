...
public abstract class AbstractJdbcMealRepository<T> implements MealRepository {
    ...
    abstract T convertTimeStamp(LocalDateTime dateTime);
    ...
    public List<Meal> getBetweenInclusive(LocalDate startDate, LocalDate endDate, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, convertTimeStamp(getStartInclusive(startDate)), convertTimeStamp(getEndExclusive(endDate)));
    }
}
