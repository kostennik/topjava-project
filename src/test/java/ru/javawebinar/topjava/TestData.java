...
public class TestData {
    ...
    public static <T extends HasId> ResultMatcher contentJson(Class<T> tClass, T expected) {
    ...
    public static <T extends HasId> ResultMatcher contentJson(Class<T> tClass, Iterable<T> expected) {
